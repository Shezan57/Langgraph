...
# Initialize the LLM model (using Groq in the example)
model = ChatGroq(
    api_key=api_key,
    model="llama-3.3-70b-versatile"
)

# Node function to handle the user query adn call the LLM
...
# Example input message for the user
input_message = {
