...
def add_world(state: InputState) -> OverallState:
    ...
    print(f"Node 1 - add_word: Transformed '{state['user_input']} '{partial_message}'")
...
def add_exclamation(state: OverallState) -> PrivateState:
    ...
    print(f"Node 2 - add_exclamation: Transformed '{state['user_input']} '{private_message}'")
...
def finalize_message(state: PrivateState) -> OutputState:
    ...
    print(f"Node 3 - finalize_message: Finalized message '{message_output}'")
